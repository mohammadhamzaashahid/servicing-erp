  ...
  const handleCreate = async (payload, resetForm) => {
    ...
    try {
      ...
      if (createdInvoice?.id) {
        await handlePrintInvoice(createdInvoice.id);
      }
    } catch (error) {
      setFormError(error.message || "Unable to post sales invoice");
    }
  };
      ...
      <section className="flex flex-col justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Create customer invoices, reduce product stock, track payments, and
            print professional receipts for business use.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm">
                {invoicesQuery.error?.message || "Please try again."}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-amber-200 bg-amber-50 p-5 text-amber-800">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm">
                Creating an invoice requires customers and products to load
                successfully.
              </p>
            </div>
          </div>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between px-1">
          <p className="text-sm text-slate-500">
            {pagination
              ? `${pagination.total} total invoice${
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-5">
                <div className="rounded-xl bg-slate-50 p-3">
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-950">
                    {formatMoney(detailInvoice.subtotal)}
                  </p>
                </div>
                ...
                <div className="rounded-xl bg-slate-50 p-3">
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-950">
                    {formatMoney(detailInvoice.discountAmount)}
                  </p>
                </div>
                ...
                <div className="rounded-xl bg-slate-50 p-3">
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-950">
                    {formatMoney(detailInvoice.paidAmount)}
                  </p>
                </div>
                ...
                <div className="rounded-xl bg-slate-50 p-3">
                  ...
                  <p className="mt-1 text-sm font-semibold text-slate-950">
                    {formatMoney(detailInvoice.balanceAmount)}
                  </p>
                </div>
              </div>
